        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={(e) => e.preventDefault()} className="mt-8 space-y-5">
            <div>
              ...
              <input type="email" placeholder="you@email.com" className="mt-1.5 w-full px-4 py-3 rounded-xl bg-card border border-border focus:outline-none focus:ring-2 focus:ring-amber-500/30" />
            </div>
          ...
          <p className="mt-6 text-center text-sm text-muted-foreground">
            Remember your password? <Link to="/login" className="text-amber-600 font-medium hover:underline">Log in</Link>
          </p>
        </div>
      </main>
      <Footer />
